...
CAMPUS_USER_ACCOUNT="$(prompt_required "Campus user account, e.g. 1224077021@cmcc")"
...
CAMPUS_PROBE_URL="$(prompt_default "Probe URL" "http://cp.cloudflare.com/generate_204")"
...
CAMPUS_AFTER_LOGIN_DELAY="$(prompt_default "Seconds to wait after login before recheck" "5")"
